    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bg_image_outer_container', filer.fields.image.FilerImageField(related_name='work_workappcontentplugin_bg_image', blank=True, to='filer.Image', help_text='Dimensions TBD', null=True, verbose_name='Background-Image')),
                ('categories', models.ManyToManyField(to='allink_categories.AllinkCategory', blank=True)),
