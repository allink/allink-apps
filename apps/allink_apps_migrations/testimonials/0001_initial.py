...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TestimonialAppContentPlugin',
            fields=[
                ...
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, related_name='testimonials_testimonialappcontentplugin', primary_key=True, serialize=False, to='cms.CMSPlugin')),
                ...
                ('bg_image_outer_container', filer.fields.image.FilerImageField(related_name='testimonials_testimonialappcontentplugin_bg_image', blank=True, to='filer.Image', help_text='Dimensions TBD', null=True, verbose_name='Background-Image')),
                ('categories', models.ManyToManyField(to='allink_categories.AllinkCategory', blank=True)),
                ('manual_entries', aldryn_common.admin_fields.sortedm2m.SortedM2MModelField(help_text='Select and arrange specific entries, or, leave blank to select all. (If manual entries are selected the category filtering will be ignored.)', to='testimonials.Testimonial', blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testimonial', adminsortable.fields.SortableForeignKey(blank=True, to='testimonials.Testimonial', help_text='The first image will be used as preview image.', null=True, verbose_name='Images')),
            ],
            options={
                'ordering': ('sort_order',),
                'abstract': False,
