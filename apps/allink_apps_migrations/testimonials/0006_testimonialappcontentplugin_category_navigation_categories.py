...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('testimonials', '0005_testimonial_street_nr'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ManyToManyField(help_text='You can explicitly define the categories for the category navigation here. This will override the automatically set of categories. (Either from "Filter & Ordering" or from the "Manual entries")', related_name='testimonials_testimonialappcontentplugin_category_navigation', verbose_name='Categories for Navigation', to='allink_categories.AllinkCategory', blank=True),
        ),
    ]
