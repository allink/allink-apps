...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('people', '0006_peopleappcontentplugin_category_navigation_categories'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(help_text='You can explicitly define the categories for the category navigation here. This will override the automatically set of categories. (Either the one generated from "Filter & Ordering" or "Manual entries")', related_name='people_peopleappcontentplugin_category_navigation', verbose_name='Categories for Navigation', to='allink_categories.AllinkCategory', blank=True),
        ),
        migrations.AddField(
            model_name='peopleappcontentplugin',
            name='filter_fields',
