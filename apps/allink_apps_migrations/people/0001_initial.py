    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(help_text='Required Format: +41 41 345 67 89', max_length=128, null=True, verbose_name='Phone', blank=True)),
                ('mobile', phonenumber_field.modelfields.PhoneNumberField(help_text='Required Format: +41 41 345 67 89', max_length=128, null=True, verbose_name='Mobile', blank=True)),
                ('fax', phonenumber_field.modelfields.PhoneNumberField(help_text='Required Format: +41 41 345 67 89', max_length=128, null=True, verbose_name='Fax', blank=True)),
                ...
                ('company_name', models.CharField(max_length=255, null=True, verbose_name='Company Name', blank=True)),
                ('place', models.CharField(max_length=255, null=True, verbose_name='Place', blank=True)),
                ('gender', models.IntegerField(null=True, verbose_name='Gender', choices=[(2, 'Female'), (1, 'Male')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_css_classes', allink_core.allink_base.models.model_fields.Classes(default=b'', help_text='Space separated classes that are added to the class. See <a href="http://getbootstrap.com/css/" target="_blank">Bootstrap 3 documentation</a>.', verbose_name='Css Classes', blank=True)),
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, related_name='people_peopleappcontentplugin', primary_key=True, serialize=False, to='cms.CMSPlugin')),
                ...
                ('bg_image_outer_container', filer.fields.image.FilerImageField(related_name='people_peopleappcontentplugin_bg_image', blank=True, to='filer.Image', help_text='Dimensions TBD', null=True, verbose_name='Background-Image')),
                ('categories', models.ManyToManyField(to='allink_categories.AllinkCategory', blank=True)),
                ('manual_entries', aldryn_common.admin_fields.sortedm2m.SortedM2MModelField(help_text='Select and arrange specific entries, or, leave blank to select all. (If manual entries are selected the category filtering will be ignored.)', to='people.People', blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('people', adminsortable.fields.SortableForeignKey(blank=True, to='people.People', help_text='The first image will be used as preview image.', null=True, verbose_name='Images')),
            ],
            options={
                'ordering': ('sort_order',),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_title', models.CharField(default=b'', max_length=255, verbose_name='Job Title')),
                ('job_function', models.CharField(default=b'', max_length=255, verbose_name='Function')),
                ...
                ('master', models.ForeignKey(related_name='translations', editable=False, to='people.People', null=True)),
            ],
            options={
                'managed': True,
                'db_table': 'people_people_translation',
                'db_tablespace': '',
                'default_permissions': (),
