    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('language_code', models.CharField(max_length=15, verbose_name='Language', db_index=True)),
                ('costs', models.CharField(help_text='Costs for the Event.', max_length=255, null=True, blank=True)),
            ],
            options={
                'managed': True,
                ...
                'db_tablespace': '',
                'default_permissions': (),
                'verbose_name': 'Events entry Translation',
            },
        ),
        migrations.CreateModel(
            name='Events',
            ...
            options={
                ...
                'verbose_name_plural': 'Events entries',
            },
            bases=('blog.blog',),
        ),
        migrations.CreateModel(
