...
def translate_meta_fields(apps, schema_editor):
    ...
    WorkTranslation = apps.get_model('work', 'WorkTranslation')
    language_code = settings.LANGUAGES[0][0]
    activate(language_code)

    for b in Work.objects.all():
        translation = _get_translation(b, WorkTranslation)
